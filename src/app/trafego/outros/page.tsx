...
export default async function TrafegoOutrosPage() {
  ...
  const filtradas = filtrarPorCategoria(linhas, "outros");
  return (
    <TrafegoCategoriaView
      linhas={filtradas}
      vazioMsg="Sem campanhas em Outros. Categoria pega o que sobra das 3 anteriores."
    />
  );
}
