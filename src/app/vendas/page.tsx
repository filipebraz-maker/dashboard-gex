...
import { MesPills } from "@/components/MesPills";
...
export default async function VendasPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="px-4 md:px-6 lg:px-8 py-5 md:py-6 max-w-[1600px] mx-auto pb-24">
      <header className="reveal flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-5">
        <div>
        ...
        <MesPills pathname="/vendas" options={PERIODO_OPTIONS} currentKey={periodo.key} />
      </header>
