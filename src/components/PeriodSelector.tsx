...
export function PeriodSelector({ options, currentKey, currentLabel }: PeriodSelectorProps) {
  ...
  // Estado dos campos de data — inicializa com o que está na URL ou últimos 30d
